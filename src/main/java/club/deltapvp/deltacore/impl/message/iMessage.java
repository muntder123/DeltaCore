package club.deltapvp.deltacore.impl.message;

import club.deltapvp.deltacore.api.utilities.message.Message;
import club.deltapvp.deltacore.core.Replacer;
...
public class iMessage implements Message {
    ...
    public void send(List<Player> list) {
        list.forEach(player -> player.sendMessage(ChatColor.translateAlternateColorCodes('&', message)));
    }
